...
parfor ibootstrap = start_id:end_id % cross_valid_id
    ...
    Var_Decom_Tau_30cm = nan(ValidGrid, 9);
    Var_Decom_Tau_100cm = nan(ValidGrid, 9);
    Var_Decom_Tau_200cm = nan(ValidGrid, 9);
    Var_Decom_Tau_Total = nan(ValidGrid, 9);
    ...
    save_pathway = {[data_path, 'output_data/world_simulation_analyses/compontent_control_soc_total_stock_GCB_',  model_name, '_', nn_exp_name, '_control_test.mat']};
