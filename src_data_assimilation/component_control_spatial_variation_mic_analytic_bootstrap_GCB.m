...
% for ibootstrap = start_id:10:end_id
    ...
    for icomponent = 2 %1:size(indi_map_project_mod, 3)
...
%         ylim([1.5, 6])
    ...
    save_pathway = {[data_path, 'output_data/world_simulation_analyses/compontent_control_spatial_variation_GCB_', model_name, '_', time_domain, '_', exp_name, '.mat']};
