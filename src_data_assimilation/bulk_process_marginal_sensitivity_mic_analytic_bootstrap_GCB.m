...
parfor ibootstrap = start_id:end_id % 1:200
        ...
        for imanage = 1:length(manage_proposal)
            ...
            if process_id ~= 7
                ...
                if process_id == 1
                	...
                	Para(para_E_loc) = Para(para_E_loc) + manage_proposal(imanage)*Para(para_E_loc);
				end
            ...
            bulk_process_A(iGrid, var_loc) = bulk_A_integrate;
            ...
            bulk_process_E(iGrid, var_loc) = litter_fraction;
    ...
    save_pathway = {[data_path, 'output_data/world_simulation_analyses/marginal_sensitivity_proda_GCB_', process_manage_list{process_id}, '_', model_name, '_', nn_exp_name, '.mat']};
