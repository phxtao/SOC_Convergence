...
parfor ibootstrap = start_id : end_id
    ...
    manage_proposal = -0.2:0.04:0.2; % -0.5:0.1:0.5;
    ...
    for iGrid = 1:length(GridInfo)
        ...
        [carbon_input, ~, ~, soc_layer, total_res_time, total_res_time_base, ~, ~, ~, bulk_A, bulk_K, bulk_V, bulk_Xi, bulk_I, litter_fraction] ...
        ...
        bulk_process_summary(iGrid, :) = [bulk_A, bulk_I, bulk_K, bulk_V, bulk_Xi, carbon_input, litter_fraction];
    end
